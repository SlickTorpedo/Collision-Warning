...
def main():
    ...
    while(cap.isOpened()):
        ...
        if (len(parsed_images) >= 2):
            ...
            #Cap all the values to max_distance_cap_in_meters (len(points) == max_distance_cap_in_meters)
            points_ll_t = points_ll_t.clip(0, max_distance_cap_in_meters)
            points_ll_t2 = points_ll_t2.clip(0, max_distance_cap_in_meters)
            points_l_t = points_l_t.clip(0, max_distance_cap_in_meters)
            points_l_t2 = points_l_t2.clip(0, max_distance_cap_in_meters)
            points_road_t = points_road_t.clip(0, max_distance_cap_in_meters)
            points_road_t2 = points_road_t2.clip(0, max_distance_cap_in_meters)
